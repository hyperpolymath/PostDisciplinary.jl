= Postdisciplinary.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/PostDisciplinary.jl
...
* https://github.com/hyperpolymath/PostDisciplinary.jl/issues — report bugs
