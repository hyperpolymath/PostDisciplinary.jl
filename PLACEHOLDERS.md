...
| Placeholder | Description | Example | Files |
|---|---|---|---|
| `PostDisciplinary.Jl` | Human-readable project name | `My Project` | SECURITY.md, CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md, MAINTAINERS.md, flake.nix, devcontainer.json |
| `PostDisciplinary.jl` | One-line description | `A tool for X` | flake.nix |
