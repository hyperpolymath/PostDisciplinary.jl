...
git clone <https://github.com/hyperpolymath/PostDisciplinary.jl.git> cd
PostDisciplinary.jl
...
toolbox create PostDisciplinary.jl-dev toolbox enter
PostDisciplinary.jl-dev \# Install dependencies manually
...
PostDisciplinary.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/PostDisciplinary.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/PostDisciplinary.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/PostDisciplinary.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/PostDisciplinary.jl/labels/perimeter-3) — Community sandbox scope
