...
git clone https://github.com/hyperpolymath/PostDisciplinary.jl.git
cd PostDisciplinary.jl
...
toolbox create PostDisciplinary.jl-dev
toolbox enter PostDisciplinary.jl-dev
