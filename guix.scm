...
;;
;; Guix package definition for PostDisciplinary.jl
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace PostDisciplinary.jl and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/PostDisciplinary.jl")
  (synopsis "PostDisciplinary.jl")
